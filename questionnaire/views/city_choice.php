...
<div id="main_container">
  ...
  <section id="choose">
    ...
    <? // this block of code puts in the city selection divs - Ryan
     foreach ($cities as $city) : ?>
     <!-- Get name-value pairs used to load the next page in the sequence -->
     <a href="index.php?cityID=<? echo $city['CityID']; ?>&cityName=<? echo $city['Name'];
             ?>&newPage=Category">
          <div class="box" id="<? echo $city['Name'];?>">
            <? echo $city['Name'];?>
          </div></a>
                <?endforeach; // end of city selection divs block of code -Ryan ?>
