<?php
	...
	require_once('C_ClassActivity.php');
	require_once('C_IUDactivity.php');
...
// this is function that will query the options database based on the option selected
 ...
 function getActivityResults($db, $ActivityID)
 {
 	$ActivityID=1;
...
<div id="main_container">
 ...
 <?     
      $activityresults = getActivityResults($db, $ActivityID);
